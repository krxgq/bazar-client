    ...
    <header>
      ...
      <nav>
        <ul className="nav-links">
          {isLoggedIn ? (
            <>
              <li id="favourites" className="nav-links-svg">
                <Link to="/fav">
                  <svg
              ...
              <li id="addItem" className="nav-links-svg">
                <Link to="/add">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    x="0px"
        ...
        <ul className={`nav-links-mobile ${menuOpen ? "show" : ""}`}>
          {isLoggedIn ? (
            <>
              <li id="profile-mobile">
                 <Link to="/account">Profile</Link>
              </li>
              <li id="favourites-mobile">
                <Link to="/fav">Favourites</Link>
              </li>
              <li id="addItem-mobile">
